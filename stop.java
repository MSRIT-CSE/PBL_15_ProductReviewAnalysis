           ...
           "discussion","tmus","diffrent.","layout","area.","thanks","thankyou","hello","bye","rise","fell","fall","psqft.","http://","km","miles"};
			...
			try
			{
				...
				String fip1="";
					...
					FileOutputStream out = new FileOutputStream("E:/MANU/Programs/rahul/src/stopremoved.txt");

					BufferedReader br = new BufferedReader(new FileReader("E:/MANU/Programs/rahul/src/output.txt"));
				     while ((fip1 = br.readLine()) != null) 
				     {
				    	 
				    	 String[] tokens  = fip1.split(" ");
				    	 String fip2 = "";
